/*
 * File: feature_accel_discs.c
 * Author: James Kuczynski
 * Email: jkuczyns@cs.uml.edu
 * File Description: This file processes data from the watches sensors.
 *
 * Created 04/07/2015
 */
...
/*
 * Create 2D vector to contain x and y coordinates.
 */
...
/*
 * Create structure to contain position, velocity, mass, and radius.
 */
typedef struct Disc
{
#ifdef PBL_COLOR
...
/*
 * This function dealocates memory and stops subscribing
 * to the sensors.
 */
